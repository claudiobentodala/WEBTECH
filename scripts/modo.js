let ligth = window.document.querySelector('img#ligth')
let dark = window.document.querySelector('img#dark')
let fundo = window.document.querySelector('body')

let link_home = {text: window.document.querySelector('a#texta'),
